# Generated by Django 3.1.3 on 2023-04-21 15:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fist_name', models.CharField(blank=True, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('repayment_term', models.IntegerField(blank=True, choices=[(1, '1 Month'), (2, '3 Months'), (3, '6 Months'), (4, '1 Year')], null=True)),
                ...
                ('borrower_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.borrower')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('repayment_term_range', models.IntegerField(blank=True, null=True)),
                ('loan_amount_range', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
